...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SessionStatus, event_),
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TaggedRunMetadata_default_instance_);_SessionStatus_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_SessionStatus_default_instance_);_Event_default_instance_.file_version_.UnsafeSetDefault(
...
SessionStatus* SessionStatus::New(::google::protobuf::Arena* arena) const {
...
// repeated .tensorflow.Event event = 1;
int SessionStatus::event_size() const {
  return event_.size();
}
void SessionStatus::clear_event() {
  event_.Clear();
}
const ::tensorflow::Event& SessionStatus::event(int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.SessionStatus.event)
  return event_.Get(index);
}
::tensorflow::Event* SessionStatus::mutable_event(int index) {
  // @@protoc_insertion_point(field_mutable:tensorflow.SessionStatus.event)
  return event_.Mutable(index);
}
::tensorflow::Event* SessionStatus::add_event() {
