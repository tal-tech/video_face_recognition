...
#ifndef D__WORK_LIB_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_SENDRECV_OPS_H_
#define D__WORK_LIB_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_SENDRECV_OPS_H_
...
class _HostRecv {
 public:
  ...
  struct Attrs {
    ...
    ///
    /// Defaults to false
    TF_MUST_USE_RESULT Attrs ClientTerminated(bool x) {
      Attrs ret = *this;
...
#endif  // D__WORK_LIB_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_SENDRECV_OPS_H_
