...
#ifndef D__WORK_LIB_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_BOOSTED_TREES_OPS_INTERNAL_H_
#define D__WORK_LIB_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_BOOSTED_TREES_OPS_INTERNAL_H_
...
class BoostedTreesCalculateBestGainsPerFeature {
 public:
  BoostedTreesCalculateBestGainsPerFeature(const ::tensorflow::Scope& scope,
                                         ...
                                         stats_summary_list, float l1, float
                                         l2, float tree_complexity, int64
                                         max_splits);
...
/// shape.
/// * max_depth: scalar, max depth of trees. To be used for parallelization costs.
///
/// Returns:
...
class BoostedTreesPredict {
 public:
  BoostedTreesPredict(const ::tensorflow::Scope& scope, ::tensorflow::Input
                    ...
                    bucketized_features, int64 logits_dimension, int64
                    max_depth);
...
class BoostedTreesTrainingPredict {
 public:
  BoostedTreesTrainingPredict(const ::tensorflow::Scope& scope,
                            ...
                            logits_dimension, int64 max_depth);
...
class BoostedTreesUpdateEnsemble {
 public:
  BoostedTreesUpdateEnsemble(const ::tensorflow::Scope& scope,
                           ...
                           ::tensorflow::InputList right_node_contribs, int64
                           max_depth, float learning_rate, int64 pruning_mode);
  operator ::tensorflow::Operation() const { return operation; }
...
#endif  // D__WORK_LIB_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_BOOSTED_TREES_OPS_INTERNAL_H_
