...
#include "D:/work/lib/tensorflow/tensorflow/contrib/cmake/build/tensorflow/cc/ops/boosted_trees_ops_internal.h"
...
BoostedTreesCalculateBestGainsPerFeature::BoostedTreesCalculateBestGainsPerFeature(const ::tensorflow::Scope& scope, ::tensorflow::Input node_id_range, ::tensorflow::InputList stats_summary_list, float l1, float l2, float tree_complexity, int64
                                                                                   max_splits) {
  if (!scope.ok()) return;
  ...
  auto builder = ::tensorflow::NodeBuilder(unique_name, "BoostedTreesCalculateBestGainsPerFeature")
                     ...
                     .Attr("l1", l1)
                     .Attr("l2", l2)
                     .Attr("tree_complexity", tree_complexity)
...
BoostedTreesUpdateEnsemble::BoostedTreesUpdateEnsemble(const
  ...
  auto builder = ::tensorflow::NodeBuilder(unique_name, "BoostedTreesUpdateEnsemble")
                     ...
                     .Attr("max_depth", max_depth)
                     .Attr("learning_rate", learning_rate)
