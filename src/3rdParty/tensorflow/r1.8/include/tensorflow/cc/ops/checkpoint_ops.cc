...
#include "D:/work/lib/tensorflow/tensorflow/contrib/cmake/build/tensorflow/cc/ops/checkpoint_ops.h"
...
GenerateVocabRemapping::GenerateVocabRemapping(const ::tensorflow::Scope&
  ...
  auto builder = ::tensorflow::NodeBuilder(unique_name, "GenerateVocabRemapping")
                     ...
                     .Attr("old_vocab_size", attrs.old_vocab_size_)
  ;
...
GenerateVocabRemapping::GenerateVocabRemapping(const ::tensorflow::Scope&
                                               ...
                                               new_vocab_offset, int64
                                               num_new_vocab)
  : GenerateVocabRemapping(scope, new_vocab_file, old_vocab_file, new_vocab_offset, num_new_vocab, GenerateVocabRemapping::Attrs()) {}
